...
import ros2test.api.domain_coordinator
from ros2test.api.domain_coordinator import get_coordinated_domain_id
...
class TestUniqueness(unittest.TestCase):
    ...
    def test_with_forced_collision(self):
        ...
        domain = ros2test.api.domain_coordinator.get_coordinated_domain_id(
        ...
        with self.assertRaises(Exception) as cm:
            ros2test.api.domain_coordinator.get_coordinated_domain_id(
                selector=lambda: 42
            )
...
class TestSelector(unittest.TestCase):
    ...
    def test_selector_values_between_1_and_100(self):
        selector = ros2test.api.domain_coordinator._default_selector()
